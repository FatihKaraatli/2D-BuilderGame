...
public class DragAndDropAirport : MonoBehaviour
{
    private bool startDrag;
    private bool is_enter;
    public GameObject airportDetails;
    ...
    private void Update()
    {
        ...
        if (PlayerPrefs.GetString("buildingType") != "airportbuild")
        {
            CancelBuild();
        }
    }
    ...
    public void StartDragUI()
    {
        ...
        startDrag = true;
        PlayerPrefs.SetString("buildingType", "airportbuild");
        airportDetails.SetActive(true);
    }
    ...
    public void PutHere()
    {
        ...
        airportDetails.SetActive(false);
    }
